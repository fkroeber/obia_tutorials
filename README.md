...
| :-------- | -------  | --------- |
| `01_features.ipynb` | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/fkroeber/machine_learning/blob/main/hurricane_track_forecasting/notebook/hurricane_analyses.ipynb) | calculating various feature descriptors (spectral, spatial, textural, contextural) | 
||
