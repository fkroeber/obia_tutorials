...
| :-------- | -------  | --------- |
| `01_features.ipynb` | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/fkroeber/obia_tutorials/blob/main/01_features.ipynb) | calculating various feature descriptors (spectral, spatial, textural, contextural) | 
||
